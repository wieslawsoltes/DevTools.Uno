...
internal sealed class StyleValueDetailsViewModel : ViewModelBase
{
    ...
    public StyleValueDetailsViewModel(
        string title,
        string subtitle,
        string summary,
        string kind,
    ...
    private PropertyGridNode CreateScalarGroup()
    {
        var group = new PropertyGridNode
        {
            ...
            IsGroup = true,
            IsEditable = false,
            FullName = $"STYLE-DETAILS:{Title}:{Path}",
        ...
        group.Children.Add(new PropertyGridNode
        {
            ...
            IsGroup = false,
            IsEditable = false,
            FullName = $"STYLE-DETAILS-VALUE:{Title}:{Path}",
            Editor = PropertyEditorMetadata.ReadOnly,
            GetSources = () =>
            [
    ...
    private static bool IsSimpleType(Type type)
    {
        ...
        return actualType.IsPrimitive ||
               actualType.IsEnum ||
               typeof(Type).IsAssignableFrom(actualType) ||
